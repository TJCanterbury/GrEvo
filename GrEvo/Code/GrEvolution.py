...
def SA_GrEv(G1, G2, G1_name="a", G2_name="b", goal=100, temp = 0.1, printer = False):
	...
	while best_score != 0 and parsimony <= goal:
		...
		Generation += 1
		if printer:
			print("Generation:" + str(Generation), end="\r")
...
def main(argv):
	...
	Generation, parsimony = SA_GrEv(G1, G2, temp=float(argv[3]), printer=True)
	print(Generation)
	print(parsimony)
